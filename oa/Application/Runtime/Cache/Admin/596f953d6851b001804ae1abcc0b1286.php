                                  ...
                                  <form class="form-horizontal" role="form" method="post" enctype="multipart/form-data" action="">
 									<?php if($_GET['id']!= null): ?><input type="hidden" name="id" value="<?php echo ($_GET['id']); ?>" ><?php endif; ?>
                                      ...
                                      <div class="form-group">
                                          ...
                                          <div class="col-lg-10">
                                              <input type="text" readonly class="form-control" id="sellName" placeholder="sellName"  value="<?php echo ($data["sellName"]); ?>" >
                                          </div>
                                      </div>

									<div class="form-group">
                                          <label for="sellPhone" class="col-lg-2 col-sm-2 control-label">联系方式</label>
                                          <div class="col-lg-10">
                                              <input type="text" readonly class="form-control" id="sellPhone" placeholder="sellPhone" value="<?php echo ($data["sellPhone"]); ?>" >
                                          </div>
                                      </div>
                                      ...
                                      <div class="form-group">
                                          ...
                                          <div class="col-lg-10">
                                              <a  href="/oa/<?php echo ($data["firstData"]); ?>">压缩文件</a>
                                          </div>
                                      ...
                                      <div class="form-group">
                                          ...
                                          <div class="col-lg-10">
                                              <input type="text" class="form-control" readonly id="manageEmail" placeholder="manageEmail" value="<?php echo ($data["manageEmail"]); ?>" >
                                          </div>
                                      </div>
                                      
                                      <div class="form-group">
                                          <label for="twoCode" class="col-lg-2 col-sm-2 control-label">支付二维码</label>
                                          <div class="col-lg-10">
                                             <!--  <input type="file"   id="twoCode" placeholder="twoCode" name="payCode" > -->
                                                                                    <img src="/oa/<?php echo ($data["payCode"]); ?>" />
                                          </div>
                                      </div>
                                      ...
                                      <div class="form-group">
                                          ...
                                          <div class="col-lg-10">
                                             <!--  <input type="file"   id="twoCode" placeholder="twoCode" name="payCode" > -->
                                                                                    <img src="/oa/<?php echo ($data["payImage"]); ?>" />
                                          </div>
                                      </div>
                                      ...
                                      <div class="form-group">
                                          ...
                                          <div class="col-lg-10">
                                             <!--  <input type="file"   id="twoCode" placeholder="twoCode" name="payCode" > -->
                                                                                    <a href="/oa/<?php echo ($data["secoudData"]); ?>" />压缩文件</a>
                                          </div>
                                      </div>
                                      
                                      <div class="form-group">
                                          <div class="col-lg-offset-2 col-lg-10">
                                              <input type="submit" class="btn btn-blue" value="<?php echo ($controller); ?> <?php echo ($action); ?>">
                                               <a href="/myGitRepository/oa/index.php/Manage/notApprove/id/<?php echo ($_GET['id']); ?>" class="btn btn-danger" ><?php echo ($controller); ?> not <?php echo ($action); ?></a>
                                          </div>
                                      </div>
                                  </form>
                              </div>
