                        ...
                        <div class="col-md-12	">
                            <section class="panel">
                              <header class="panel-heading">
                                  Work Progress <a href="/myGitRepository/oa/index.php/Group/add" class="pull-right badge bg-yellow">添加</a>
                            </header>
                            <div class="panel-body table-responsive">
                              ...
                              <?php if(is_array($list)): foreach($list as $key=>$vo): ?><tr>
                                 ...
                                 <td><?php echo ($vo["rules"]); ?></td>
                                  ...
                                  <!-- <td>$1500</td> -->
                                  <td><a href="/myGitRepository/oa/index.php/Group/update/id/<?php echo ($vo["id"]); ?>" class="badge bg-light-blue">修改</a></td>
                                  <td><a href="/myGitRepository/oa/index.php/Group/delete/id/<?php echo ($vo["id"]); ?>" class="badge bg-red">删除</a></td>
