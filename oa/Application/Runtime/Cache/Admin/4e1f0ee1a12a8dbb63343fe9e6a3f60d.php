                            ...
                            <ul class="sidebar-menu">
                                ...
                                <li>
                                    <a href="/oa/index.php/User/index">
                                        <i class="fa fa-gavel"></i> <span>User</span>
                                    </a>
                                </li>

                                <li>
                                    <a href="/oa/index.php/Privilege/index">
                                        <i class="fa fa-globe"></i> <span>Privilege</span>
                                    </a>
                                </li>

                                <li>
                                    <a href="/oa/index.php/Group/index">
                                        <i class="fa fa-glass"></i> <span>Group</span>
                                    </a>
                                </li>
			
								<li>
                                    <a href="/oa/index.php/UserToGroup/index">
                                        <i class="fa fa-address-card" aria-hidden="true"></i> <span>UserToGroup</span>
                                    </a>
                                </li>
                                
                                <li>
                                    <a href="/oa/index.php/ProductOrder/index">
                                        <i class="fa fa-glass"></i> <span>ProductOrder</span>
                                    </a>
                                </li>
                                
                                   <li>
                                    <a href="/oa/index.php/Manage/index">
                                        <i class="fa fa-glass"></i> <span>Manage</span>
                                    </a>
                                </li>
                            </ul>
                        </section>
