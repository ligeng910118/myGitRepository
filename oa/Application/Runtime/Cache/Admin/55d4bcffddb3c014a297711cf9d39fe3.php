                            ...
                            <div class="panel-body table-responsive">
                              ...
                              <?php if(is_array($list)): foreach($list as $key=>$vo): ?><tr>
                                 ...
                                 <td><?php echo ($vo["createTime"]); ?></td>
                                  ...
                                  <!-- <td>$1500</td> -->                                 
                                  <td><a href="/myGitRepository/oa/index.php/Manage/payCode/id/<?php echo ($vo["id"]); ?>" class="badge bg-light-blue">支付二维码</a></td>
                                  <td><a href="/myGitRepository/oa/index.php/Manage/approve/id/<?php echo ($vo["id"]); ?>" class="badge bg-light-blue">审核操作</a></td>
                                  <td><a href="/myGitRepository/oa/index.php/Manage/complete/id/<?php echo ($vo["id"]); ?>" class="badge bg-light-blue">审核完成</a></td></tr><?php endforeach; endif; ?>
                          </tbody>
                      </table>
                      <?php echo ($page); ?>
                  </div>
