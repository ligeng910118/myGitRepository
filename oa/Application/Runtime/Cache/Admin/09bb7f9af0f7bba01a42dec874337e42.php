...
<head>
    ...
    <aside class="left-side sidebar-offcanvas">
                          ...
                          <section class="panel">
                              ...
                              <div class="panel-body">
                                  <form class="form-horizontal" role="form" method="post" action="">
 									...
 									<?php if(is_array($fields)): foreach($fields as $key=>$vo): ?><div class="form-group">
                                          <label for="<?php echo ($vo); ?>" class="col-lg-2 col-sm-2 control-label"><?php echo (changechina($vo)); ?></label>
                                          <div class="col-lg-10">
                                              <input type="text" <?php if($vo == 'id'): ?>readonly<?php endif; ?> class="form-control" id="<?php echo ($vo); ?>" placeholder="<?php echo ($vo); ?>" name="<?php echo ($vo); ?>" value="<?php echo ($data["$vo"]); ?>" >
                                          </div>
                ...
                <div class="footer-main">
                    uid <?php if(is_array($username)): foreach($username as $key=>$vo): ?>【<?php echo ($vo["id"]); ?> : <?php echo ($vo["username"]); ?>】<?php endforeach; endif; ?><br />
                    group_id <?php if(is_array($group)): foreach($group as $key=>$vo): ?>【<?php echo ($vo["id"]); ?> : <?php echo ($vo["title"]); ?>】<?php endforeach; endif; ?>}
                </div>
            </aside><!-- /.right-side -->
