...
<?php if(!empty($normal_tips)): ?><p class="normal_tips"><b class="fa fa-info-circle"></b> <?php echo ($normal_tips); ?></p><?php endif; ?>
      ...
      <div id="main">
	 	...
	 	<div class="mainRight">
	 		<div class="rightTitle">消息管理<div class="pull-right"><a href="index.php?s=/<?php echo ($address); ?>/Template/Template/singleMessage" class="btn pull-left">添加</a></div></div>
	 		<div class="rightContent">
	 			
	 			<div class="listRight">标题</div>
	 			<div class="listRight">模板id</div>
	 			<div class="listRight">删除</div>
	 		</div>
		 	<body>
		 		<?php if(is_array($list)): foreach($list as $key=>$vo): ?><div class="rightContent">
		 			<div class="listRight"><?php echo ($vo["first"]); ?></div>
		 			<div class="listRight"><?php echo ($vo["template_id"]); ?></div>
		 			<a href="index.php?s=/<?php echo ($address); ?>/Template/Template/deleteData/id/<?php echo ($vo["id"]); ?>" class="listRight btn">删除</a>	 			
