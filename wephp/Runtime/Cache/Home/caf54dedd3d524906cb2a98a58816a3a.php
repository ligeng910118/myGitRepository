...
<script type="text/javascript" src="/myGitRepository/wephp/Public/static/qrcode/qrcode.js"></script>
<script type="text/javascript" src="/myGitRepository/wephp/Public/static/qrcode/jquery.qrcode.js"></script>
<!-- 头部 -->
<div class="login_header">
	
    <div class="log_wrap">
        <a href="/" title="WeiPHP"><img class="logo" src="/myGitRepository/wephp/Public/Home/images/logo.png"/></a>
    </div>
    	...
    	<div class="top_content">
        	<div class="log_wrap">
            	<div class="top_content_r">
                	<img src="/myGitRepository/wephp/Public/Home/images/about/img/banner_pic.png?20150723"/>
                </div>
            	<section class="login_box">
                  <form class="login-form" action="/myGitRepository/wephp/index.php?s=/w16/Home/User/login.html" method="post">
